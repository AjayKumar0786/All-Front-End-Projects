  ...
  return (
    <div className="my-[100px]">
      ...
      <div className="w-11/12 mx-auto">
        <div>
          <button className="border-2 border-gray-300 py-1 px-4 rounded-md mb-6 ml-[195px]" onClick={() => navigate(-1)}>Back</button>
        ...
        <div>
          {loading ? (
            ...
            <div >
              ...
              <h2 className="text-2xl font-bold my-10 ml-[190px]">Releated Blogs</h2>
